...
if(A == "9.99"){
    document.getElementsByClassName("row-space-between")[0].children[2].children[0].style.display = "block"
}
document.getElementsByClassName("row-space-between")[0].children[2].children[0].addEventListener('click',function(){
...
if(B == "9.99"){
    document.getElementsByClassName("row-space-between")[1].children[2].children[0].style.display = "block"
}
document.getElementsByClassName("row-space-between")[1].children[2].children[0].addEventListener('click',function(){
...
if(C == "9.99"){
    document.getElementsByClassName("row-space-between")[2].children[2].children[0].style.display = "block"
}
document.getElementsByClassName("row-space-between")[2].children[2].children[0].addEventListener('click',function(){
...
if(D == "9.99"){
    document.getElementsByClassName("row-space-between")[3].children[2].children[0].style.display = "block"
}
document.getElementsByClassName("row-space-between")[3].children[2].children[0].addEventListener('click',function(){
...
if(E == "9.99"){
    document.getElementsByClassName("row-space-between")[4].children[2].children[0].style.display = "block"
}
document.getElementsByClassName("row-space-between")[4].children[2].children[0].addEventListener('click',function(){
...
/* MON LOCAL STORAGE CHELOU ATTENTION C COMPLIQUEEEE*/ 
var UIUX = ` 
{
...
boutonUiux.addEventListener('click',function(){
    ...
    rafraichir()}
        ...
        textnotif.innerHTML = 'Plus de cours disponible'
        document.getElementById('notification').style.visibility = 'visible'
        setTimeout(function(){
            document.getElementById('notification').style.visibility = 'hidden'
        }, 3000)
